<template>
  <div v-if="breadcrumbs && breadcrumbs.length > 0" class="-mx-4 md:-mx-8 -mt-4 lg:-mt-8 lg:max-w-6xl lg:mx-auto">
    <div
      ...
      class="bg-gray-300 dark:bg-gray-800 dark:text-gray-400 text-gray-800 flex flex-row py-2 px-4 whitespace-no-wrap text-sm md:text-base lg:absolute min-w-full lg:left-0 lg:px-8 mb-4 lg:mb-8 overflow-y-hidden overflow-x-auto whitespace-nowrap"
    >
