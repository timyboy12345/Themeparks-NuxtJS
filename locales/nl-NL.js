export default {
  ...
  park: {
    ...
    showRidesOnMap: 'Bekijk attracties op kaart',
    showShowsOnMap: 'Bekijk shows op kaart',
    showRestaurantsOnMap: 'Bekijk restaurants op kaart',
    ...
    allShopsOf: 'Alle Winkels van {0}',
    allShopsSubtitle: 'Bekijk alle winkels van dit park',
    allShows: 'Alle Shows',
    allShowsOf: 'Alle Shows van {0}',
  ...
  ride: {
    ...
    waitTimes: 'Huidige Wachttijden',
    waitTimesSubTitle: 'Wachttijden van alle rijen, zoals single rider en virtuele wachtrijen',
    virtualQueueTitle: 'Virtuele Wachtrij',
    singleRiderQueueTitle: 'Single Rider',
    comeBackAfter: 'Kom terug om/na {0}',
    comeBackBefore: 'Kom terug voor {0}',
  ...
  statistics: {
    ...
    shortestWaitTimesOnDate: 'Kortste wachttijden van {0}',
    seoTitle: 'Wachttijdgeschiedenis van {0}',
