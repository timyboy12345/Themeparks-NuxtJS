export default {
  general: {
    ...
    states: {
      ...
      OPENS_LATER_TODAY: 'Opens later today',
      UNDEFINED: 'Unkown',
    },
  },
  home: {
  ...
  park: {
    ...
    showRidesOnMap: 'Show rides on map',
    showShowsOnMap: 'Show shows on map',
    showRestaurantsOnMap: 'Show restaurants on map',
    showMap: 'Show Map',
  ...
  ride: {
    ...
    waitTimesSubTitle: 'Wait times of all queues, like single rider queues and virtual queues',
    virtualQueueTitle: 'Virtual Queue',
    singleRiderQueueTitle: 'Single Rider',
    comeBackAfter: 'Come back at/after {0}',
    comeBackBefore: 'Come back before {0}',
