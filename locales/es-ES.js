export default {
  ...
  ride: {
    ...
    waitTimes: 'Tiempos de espera actuales',
    waitTimesSubTitle: 'Tiempos de espera de todas las líneas, como las de pasajeros individuales y las colas virtuales',
    virtualQueueTitle: 'Cola virtual',
    singleRiderQueueTitle: 'Jinete individual',
    comeBackAfter: 'Regresa a las/después de {0}',
    comeBackBefore: 'Regresa antes del {0}',
